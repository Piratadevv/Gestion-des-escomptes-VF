  ...
  theme: {
    extend: {
      colors: {
        ...
        // Financial Success - Conservative Greens
        financial: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      boxShadow: {
        ...
        'banking-xl': '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
      },
      borderRadius: {
        'banking': '0.375rem',
        'banking-lg': '0.5rem',
