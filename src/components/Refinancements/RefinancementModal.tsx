  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label htmlFor="dateRefinancement" className="block text-sm font-medium text-banking-gray-700 mb-2">
          ...
          <input
            ...
            className={`w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent ${errors.dateRefinancement ? 'border-red-300 focus:ring-red-500' : 'border-banking-gray-300 hover:border-banking-primary-400'}`}
        ...
        {/* Libellé */}
        <div>
          <label htmlFor="libelle" className="block text-sm font-medium text-banking-gray-700 mb-2">
            <svg className="w-4 h-4 inline mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
          ...
          <input
            ...
            className={`w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent ${errors.libelle ? 'border-red-300 focus:ring-red-500' : 'border-banking-gray-300 hover:border-banking-primary-400'}`}
            disabled={isSubmitting}
            maxLength={255}
            required
          />
          <div className="mt-2 flex justify-between items-start">
            {errors.libelle ? (
              ...
              <p className="text-sm text-banking-gray-500">Décrivez brièvement le refinancement (minimum 3 caractères)</p>
            )}
            <span className="text-sm text-banking-gray-400 ml-2">{formData.libelle.length}/255</span>
          </div>
        </div>

        {/* Montant refinancé */}
        <div>
          <label htmlFor="montantRefinance" className="block text-sm font-medium text-banking-gray-700 mb-2">
            <svg className="w-4 h-4 inline mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
          ...
          <input
            ...
            min="0.01"
            max="999999.99"
            className={`w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent ${errors.montantRefinance ? 'border-red-300 focus:ring-red-500' : 'border-banking-gray-300 hover:border-banking-primary-400'}`}
            disabled={isSubmitting}
            required
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label htmlFor="tauxInteret" className="block text-sm font-medium text-banking-gray-700 mb-2">
              <svg className="w-4 h-4 inline mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <input
              ...
              min="0"
              max="100"
              className={`w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent ${errors.tauxInteret ? 'border-red-300 focus:ring-red-500' : 'border-banking-gray-300 hover:border-banking-primary-400'}`}
              disabled={isSubmitting}
              required
            />
            {errors.tauxInteret && (
          ...
          <div>
            <label htmlFor="dureeEnMois" className="block text-sm font-medium text-banking-gray-700 mb-2">
              <svg className="w-4 h-4 inline mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <input
              ...
              min="1"
              max="360"
              className={`w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent ${errors.dureeEnMois ? 'border-red-300 focus:ring-red-500' : 'border-banking-gray-300 hover:border-banking-primary-400'}`}
              disabled={isSubmitting}
              required
            />
            {errors.dureeEnMois && (
          ...
          <div>
            <label htmlFor="encoursRefinance" className="block text-sm font-medium text-banking-gray-700 mb-2">
              <svg className="w-4 h-4 inline mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
                <path d="M8.433 7.418c.155-.103.346-.196.567-.267v1.698a2.305 2.305 0 01-.567-.267C8.07 8.34 8 8.114 8 8c0-.114.07-.34.433-.582zM11 12.849v-1.698c.22.071.412.164.567.267.364.243.433.468.433.582 0 .114-.07.34-.433.582a2.305 2.305 0 01-.567.267z" />
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-13a1 1 0 10-2 0v.092a4.535 4.535 0 00-1.676.662C6.602 6.234 6 7.009 6 8c0 .99.602 1.765 1.324 2.246.48.32 1.054.545 1.676.662v1.941c-.391-.127-.68-.317-.843-.504a1 1 0 10-1.51 1.31c.562.649 1.413 1.076 2.353 1.253V15a1 1 0 102 0v-.092a4.535 4.535 0 001.676-.662C13.398 13.766 14 12.991 14 12c0-.99-.602-1.765-1.324-2.246A4.535 4.535 0 0011 9.092V7.151c.391.127.68.317.843.504a1 1 0 101.511-1.31c-.563-.649-1.413-1.076-2.354-1.253V5z" clipRule="evenodd" />
              </svg>
            ...
            <input
              ...
              min="0"
              max="999999.99"
              className={`w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent ${errors.encoursRefinance ? 'border-red-300 focus:ring-red-500' : 'border-banking-gray-300 hover:border-banking-primary-400'}`}
              disabled={isSubmitting}
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="fraisDossier" className="block text-sm font-medium text-banking-gray-700 mb-2">
              <svg className="w-4 h-4 inline mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <input
              ...
              min="0"
              max="999999.99"
              className={`w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent ${errors.fraisDossier ? 'border-red-300 focus:ring-red-500' : 'border-banking-gray-300 hover:border-banking-primary-400'}`}
              disabled={isSubmitting}
            />
            {errors.fraisDossier && (
              <p className="mt-2 flex items-center text-sm text-red-600">
          ...
          <div>
            <label htmlFor="statut" className="block text-sm font-medium text-banking-gray-700 mb-2">
              <svg className="w-4 h-4 inline mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" />
              </svg>
              Statut
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border border-banking-gray-300 rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent hover:border-banking-primary-400"
              disabled={isSubmitting}
            >
        ...
        {/* Conditions */}
        <div>
          <label htmlFor="conditions" className="block text-sm font-medium text-banking-gray-700 mb-2">
            <svg className="w-4 h-4 inline mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
          ...
          <textarea
            ...
            className={`w-full px-4 py-3 bg-gradient-to-r from-banking-gray-50 to-white border rounded-banking shadow-banking-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:border-transparent resize-none ${errors.conditions ? 'border-red-300 focus:ring-red-500' : 'border-banking-gray-300 hover:border-banking-primary-400'}`}
            rows={3}
        ...
        {showPreview && formData.montantRefinance > 0 && (
          <div className="bg-gradient-to-br from-banking-gray-50 to-white rounded-banking border border-banking-gray-200 shadow-banking-md p-6 space-y-4">
            <h4 className="flex items-center text-lg font-semibold bg-gradient-to-r from-banking-primary-600 to-banking-secondary-600 bg-clip-text text-transparent">
              <svg className="w-5 h-5 mr-2 text-banking-primary-600" fill="currentColor" viewBox="0 0 20 20">
                <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Aperçu des calculs
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white rounded-banking border border-banking-gray-100 p-4 shadow-banking-sm">
                <span className="block text-sm text-banking-gray-600 mb-1">Cumul actuel (global)</span>
                <span className="text-lg font-semibold text-banking-gray-900">{formaterMontant(cumulGlobal)}</span>
              </div>
              <div className="bg-white rounded-banking border border-banking-gray-100 p-4 shadow-banking-sm">
                <span className="block text-sm text-banking-gray-600 mb-1">Nouveau cumul</span>
                <span className="text-lg font-semibold text-banking-gray-900">{formaterMontant(impact.nouveauCumul)}</span>
              </div>
              <div className="bg-white rounded-banking border border-banking-gray-100 p-4 shadow-banking-sm">
                <span className="block text-sm text-banking-gray-600 mb-1">Autorisation</span>
                <span className="text-lg font-semibold text-banking-gray-900">{formaterMontant(autorisationBancaire)}</span>
              </div>
              <div className="bg-white rounded-banking border border-banking-gray-100 p-4 shadow-banking-sm">
                <span className="block text-sm text-banking-gray-600 mb-1">Nouvel encours</span>
        ...
        {/* Actions */}
        <div className="flex justify-end space-x-4 pt-6 border-t border-gradient-to-r from-banking-gray-200 to-banking-gray-300">
          <button 
            type="button" 
            onClick={handleClose} 
            disabled={isSubmitting} 
            className="px-6 py-3 bg-gradient-to-r from-banking-gray-100 to-banking-gray-200 text-banking-gray-700 font-medium rounded-banking border border-banking-gray-300 shadow-banking-sm hover:from-banking-gray-200 hover:to-banking-gray-300 hover:shadow-banking-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-gray-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button 
            ...
            className="px-6 py-3 bg-gradient-to-r from-banking-primary-600 to-banking-secondary-600 text-white font-medium rounded-banking shadow-banking-md hover:from-banking-primary-700 hover:to-banking-secondary-700 hover:shadow-banking-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-banking-primary-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
          >
            {isSubmitting ? (
